...
/**
 * Planned billing (receivable) line per technical-scope item for a project.
 * Actuals are read live from the invoices table by project_unique_id and NOT stored here.
 */
@Entity
