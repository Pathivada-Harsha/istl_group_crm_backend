...
/**
 * DTOs for the Project detail view (Technical Scope + Commercial tabs).
 * Kept in one file to mirror the lightweight wrapper style used elsewhere.
 * Structurally identical to OrderBookDetailWrapper but keyed by project.
 */
public class ProjectDetailWrapper {
    ...
    public static class CommercialSummary {
        ...
        private BigDecimal orderValue;         // project.budget, for reference
